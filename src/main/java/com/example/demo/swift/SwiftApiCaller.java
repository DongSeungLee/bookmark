...
public class SwiftApiCaller {
    ...
    public class Files {
        ...
        public SwiftApiCaller.HttpExecutor uploadWithTtlSetting(String containerName, String objectId, InputStream inputStream, boolean isAutoClose, boolean isPeriod, String timestamp) {
            ...
            if (StringUtils.isNotBlank(timestamp)) {
                String headerName = isPeriod ? "X-Delete-After" : "X-Delete-At";
                SwiftApiCaller.this.addHeader(headerName, timestamp);
            }
